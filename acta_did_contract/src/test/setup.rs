...
impl<'a> DIDContractTest<'a> {
    pub fn setup() -> Self {
        ...
        let did_method = String::from_str(&env, "acta");
        let context = vec![
            &env,
        ...
        let verification_methods = vec![
            ...
            VerificationMethodEntry {
                ...
                type_: VerificationMethodType::Ed25519VerificationKey2020,
                controller: String::from_str(&env, "did:acta:ujonoldr6vfinvl3a32su5lw"),
                public_key_multibase: String::from_str(
                    &env,
        ...
        let services = vec![
            &env,
            Service {
                id: String::from_str(&env, "acta"),
                type_: ServiceType::LinkedDomains,
                service_endpoint: String::from_str(&env, "https://acta.example"),
            },
        ];
